        ...
        <div class="col-md-12">
            ...
            <ul id="project-tabs" data-toggle="ajax-tab" class="nav nav-tabs classic" role="tablist">
                <?php if ($this->login_user->user_type === "staff") { ?>
                    ...
                    <li><a role="presentation" href="<?php echo_uri("projects/files_client/" . $project_info->id); ?>" data-target="#project-files-client-section">Files Client</a></li>
                ...
                <li><a role="presentation" href="<?php echo_uri("projects/files_client/" . $project_info->id); ?>" data-target="#project-files-section"> <?php echo lang('files'); ?></a></li>    
                <?php    
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane fade" id="project-files-client-section"></div>
