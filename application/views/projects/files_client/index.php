<div class="panel">
    <div class="tab-title clearfix">
        ...
        <div class="title-button-group">
            ...
            if($this->login_user->user_type == "client") {
                echo modal_anchor(get_uri("projects/file_modal_form_client"), "<i class='fa fa-plus-circle'></i> " . lang('add_files'), array("class" => "btn btn-default", "title" => lang('add_files'), "data-post-project_id" => $project_id));    
            }
    ...
    <div class="table-responsive">
        <table id="project-file-table-client" class="display" width="100%">            
        </table>
    </div>
</div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#project-file-table-client").appTable({
            source: '<?php echo_uri("projects/files_list_data_client/" . $project_id) ?>',
            order: [[0, "desc"]],
            columns: [
